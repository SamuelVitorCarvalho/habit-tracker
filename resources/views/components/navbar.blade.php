<nav>
  <ul class="flex gap-4 items-center">
    ...
    <li>
      <a href="{{ route('habits.history') }}" class="text-md border-r-2 border-habit-orange pr-2 hover:underline">
        Histórico
      </a>
    </li>
    <li>
      <a href="#" class="text-md border-r-2 border-habit-orange pr-2 hov'er:underline">
        Calendário
      </a>
    </li>
    <li>
